...
const MajorList = () => {
    ...
    // Load majors data
    const loadMajors = async (page = 0, size = pageSize, search = '', searchBy = 'name') => {
        try {
            setLoading(true);
            setError(null);
    ...
    const getSearchTypeDisplayText = (type) => {
        switch (type) {
            case 'name': return 'Tên Ngành Học';
            case 'departmentResponse.name': return 'Tên Khoa';
            default: return type;
        }
    };
                ...
                <div className="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div className="d-flex gap-2">
                        <Button
                            ...
                            onClick={() => loadMajors(currentPage, pageSize, searchTerm, searchType)}
                            disabled={loading}
                        >
                    ...
                    <div className="card-body p-0">
                                ...
                                <Dropdown>
                                    ...
                                    <Dropdown.Menu>
                                        ...
                                        <Dropdown.Item 
                                            ...
                                            onClick={() => handleSearchTypeChange('departmentResponse.name')}
                                        >
                                            Tên Khoa
                                        </Dropdown.Item>
                                    </Dropdown.Menu>
                        ...
                        {loading ? (
                            ...
                            <div className="text-center py-5">
                                ...
                                />
                                <p className="text-muted mb-0">
                                    {searchTerm ? 'Không tìm thấy ngành học nào.' : 'Chưa có ngành học nào.'}
                                </p>
                            </div>
                        ) : (
                            <>
                                            ...
                                            <tr key={major.id}>
                                                ...
                                                <td>
                                                    <Dropdown align="end">
                                                        ...
                                                        <Dropdown.Menu>
                                                            <Dropdown.Item onClick={() => handleViewMajor(major)}>
                                                                <FontAwesomeIcon icon={faEye} className="me-2" />
                                                                Xem Chi Tiết
                                                            </Dropdown.Item>
                                                            <Dropdown.Item onClick={() => handleEditMajor(major)}>
                                ...
                                <div className="d-flex justify-content-between align-items-center p-3 border-top">
                                    <div className="text-muted small">
                                        Hiển thị {Math.min(pageSize, majors.length)} / {totalElements} ngành học
                                    </div>
