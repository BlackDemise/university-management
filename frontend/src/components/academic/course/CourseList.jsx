...
const CourseList = () => {
  ...
  const getStatusBadge = (course) => {
    const totalCredits =
      (course.creditsTheory || 0) + (course.creditsPractical || 0);
    if (totalCredits === 0) {
        ...
        <div className="d-flex justify-content-between align-items-center mb-4">
          ...
          <div className="d-flex gap-2">
            <Button
              ...
              onClick={() =>
                loadCourses(currentPage, pageSize, searchTerm, searchType)
              }
              disabled={loading}
            >
                        ...
                        courses.map((course, index) => {
                          ...
                          return (
                            <tr key={course.id}>
                              ...
                              <td>
                                <Badge
                                  bg={getCourseTypeBadgeVariant(
                                    course.courseType
                                  )}
                                >
                                  {courseTypeDisplayMap[course.courseType] ||
                                    course.courseType ||
                                    "N/A"}
                                </Badge>
                              </td>
