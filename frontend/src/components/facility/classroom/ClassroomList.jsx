...
import {
    ...
    faChalkboard, faBuilding, faUsers
...
const ClassroomList = () => {
    ...
    const loadClassrooms = async (page = 0, size = pageSize, search = '', searchBy = 'roomNumber') => {
        try {
            setLoading(true);
            setError(null);
    ...
    const handleDeleteClassroom = async (classroom) => {
        if (window.confirm(`Bạn có chắc chắn muốn xóa phòng học "${classroom.roomNumber}"?`)) {
            try {
    ...
    const getSearchTypeDisplayText = (type) => {
        switch (type) {
            case 'roomNumber': return 'Số Phòng';
                ...
                <div className="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div className="d-flex gap-2">
                        <Button
                            ...
                            onClick={() => loadClassrooms(currentPage, pageSize, searchTerm, searchType)}
                            disabled={loading}
                        >
                                ...
                                <tbody>
                                    {classrooms.map(classroom => (
                                        <tr key={classroom.id}>
                                            ...
                                            <td>
                                                <Badge bg={getClassroomTypeBadgeVariant(classroom.classroomType)}>
                                            ...
                                            <td>
                                                <Dropdown align="end">
                                                    ...
                                                    <Dropdown.Menu>
                                                        <Dropdown.Item onClick={() => handleViewClassroom(classroom)}>
                                                            <FontAwesomeIcon icon={faEye} className="me-2" />
                                                            Xem Chi Tiết
                                                        </Dropdown.Item>
                                                        <Dropdown.Item onClick={() => handleEditClassroom(classroom)}>
                        ...
                        {!loading && classrooms.length > 0 && (
                            <div className="d-flex justify-content-between align-items-center p-3 border-top">
                                <div className="text-muted small">
                                    Hiển thị {Math.min(pageSize, classrooms.length)} / {totalElements} phòng học
                                </div>
