    ...
    const loadUserData = async () => {
        ...
        try {
            ...
            setFormData({
                ...
                birthDate: user.studentResponse?.birthDate || '',
                ...
                <div className="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div className="d-flex gap-2">
                        <Button
                            ...
                            onClick={() => navigate(isEditMode ? `/admin/users/details/${id}` : '/admin/users/all')}
                        >
                            <FontAwesomeIcon icon={faArrowLeft} className="me-1"/>
                            Hủy
                        </Button>
                                            ...
                                            <Col md={3}>
                                                <Form.Group className="mb-3">
                                                    ...
                                                    <Form.Control
                                                        ...
                                                        onChange={(e) => handleInputChange('courseYear', e.target.value)}
                                                        placeholder="2024"
                                                        min="2000"
                                                        max="2030"
                                                    />
