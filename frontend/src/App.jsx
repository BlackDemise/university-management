            ...
            <Router>
                <NavigationInitializer>
                    <Routes>
                        ...
                        <Route path="/admin/academic/prerequisite-courses" element={
                            <ProtectedRoute requiredRole="ADMIN">
                                <PrerequisiteCourseList/>
                            </ProtectedRoute>
                        }/>

                        <Route path="/admin/academic/prerequisite-courses/details/:courseId" element={
                            <ProtectedRoute requiredRole="ADMIN">
                                <PrerequisiteCourseDetails/>
                            </ProtectedRoute>
                        }/>

                        <Route path="/admin/academic/prerequisite-courses/edit/:courseId" element={
                            <ProtectedRoute requiredRole="ADMIN">
                        ...
                        {/* Semester Routes */}
                        <Route path="/admin/enrollment/semesters" element={
                            <ProtectedRoute requiredRole="ADMIN">
                                <SemesterList/>
                            </ProtectedRoute>
                        }/>

                        <Route path="/admin/enrollment/semesters/details/:id" element={
                            <ProtectedRoute requiredRole="ADMIN">
                                <SemesterDetails/>
                            </ProtectedRoute>
                        }/>

                        <Route path="/admin/enrollment/semesters/edit/:id" element={
                            <ProtectedRoute requiredRole="ADMIN">
                                <SemesterUpdate/>
                            </ProtectedRoute>
                        }/>
