...
@Slf4j
public class ClassroomServiceErrorDecoder implements ErrorDecoder {
    @Override
    public Exception decode(String methodKey, Response response) {
        ...
        return switch (response.status()) {
            ...
            case 404 -> new ApplicationException(ErrorCode.CLASSROOM_NOT_FOUND);
            case 503 -> new ApplicationException(ErrorCode.CLASSROOM_SERVICE_UNAVAILABLE);
