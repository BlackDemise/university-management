...
@Slf4j
public class CourseServiceErrorDecoder implements ErrorDecoder {
    @Override
    public Exception decode(String methodKey, Response response) {
        ...
        return switch (response.status()) {
            ...
            case 404 -> new ApplicationException(ErrorCode.COURSE_NOT_FOUND);
            case 503 -> new ApplicationException(ErrorCode.COURSE_SERVICE_UNAVAILABLE);
