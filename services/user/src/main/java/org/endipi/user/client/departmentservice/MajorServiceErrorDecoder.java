...
@Slf4j
public class MajorServiceErrorDecoder implements ErrorDecoder {
    @Override
    public Exception decode(String methodKey, Response response) {
        ...
        return switch (response.status()) {
            ...
            case 404 -> new ApplicationException(ErrorCode.MAJOR_NOT_FOUND);
            case 503 -> new ApplicationException(ErrorCode.ACADEMIC_SERVICE_UNAVAILABLE);
