...
VALUES (1, 'ADMIN'),
       ...
       (10, 'FINANCE_STAFF'),
       (11, 'SECURITY_STAFF'),
       (12, 'RESEARCH_MANAGER') ON DUPLICATE KEY
UPDATE role_title =
VALUES (role_title);
...
(162, 'research10@university.edu', '$2a$12$0APqcb0XWdY8Hy9kiE2QuOuzsHwc6lhAuQpvJwKEzAAUiWf0UOeMK', 12,
 'Research Manager 10') ON DUPLICATE KEY
UPDATE
    email =
VALUES (email), full_name =
VALUES (full_name), role_id =
VALUES (role_id);
...
VALUES ('T001', 2, 'Associate Professor', 'PhD Computer Science'),
       ...
       ('T010', 81, 'Lecturer', 'Master Psychology') ON DUPLICATE KEY
UPDATE
    teacher_code =
VALUES (teacher_code), academic_rank =
VALUES (academic_rank), degree =
VALUES (degree);
...
('S060', 72, '2004-08-18', 2024, 'ACTIVE') ON DUPLICATE KEY
UPDATE
    student_code =
VALUES (student_code), birth_date =
VALUES (birth_date), course_year =
VALUES (course_year), student_status =
