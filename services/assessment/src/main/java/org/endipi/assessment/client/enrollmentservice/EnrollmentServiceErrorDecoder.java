...
@Slf4j
public class EnrollmentServiceErrorDecoder implements ErrorDecoder {
    @Override
    public Exception decode(String methodKey, Response response) {
        ...
        return switch (response.status()) {
            ...
            case 500 -> new ApplicationException(ErrorCode.ENROLLMENT_SERVICE_ERROR);
            case 503 -> new ApplicationException(ErrorCode.ENROLLMENT_SERVICE_UNAVAILABLE);
